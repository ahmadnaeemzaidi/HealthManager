...
//        mAdView.loadAd(adRequest);
        ...
        if (this.extras != null && this.extras.containsKey("systolic_val"))
            this.systolic_val = Float.valueOf(this.extras.getFloat("systolic_val"));
        else
            this.systolic_val = 0.0f;

        if (this.extras != null && this.extras.containsKey("diastolic_val"))
            this.diastolic_val = Float.valueOf(this.extras.getFloat("diastolic_val"));
        else
            this.diastolic_val = 0.0f;
