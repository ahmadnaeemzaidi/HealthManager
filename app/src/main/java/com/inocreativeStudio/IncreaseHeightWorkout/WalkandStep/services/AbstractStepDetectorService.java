...
package com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.services;
...
import com.inocreativeStudio.IncreaseHeightWorkout.MainActivity;
import com.inocreativeStudio.IncreaseHeightWorkout.R;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.activities.TrainingActivity;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.models.StepCount;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.persistence.StepCountPersistenceHelper;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.persistence.TrainingPersistenceHelper;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.persistence.WalkingModePersistenceHelper;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.utils.StepDetectionServiceHelper;
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.utils.UnitHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.inocreativeStudio.IncreaseHeightWorkout.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.inocreativeStudio.IncreaseHeightWorkout.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.inocreativeStudio.IncreaseHeightWorkout.TOTAL_STEPS";
    ...
    protected Notification buildNotification(StepCount additionalStepCount) {
        ...
        mBuilder.setNotificationSilent(); // for stop notification popup
...
// Cancel the notification after its selected
        myNotication2.flags |= Notification.FLAG_AUTO_CANCEL;
