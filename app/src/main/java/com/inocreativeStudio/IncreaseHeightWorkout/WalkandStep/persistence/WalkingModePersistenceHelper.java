...
public class WalkingModePersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_WALKING_MODE_CHANGED = "com.inocreativeStudio.IncreaseHeightWorkout.WALKING_MODE_CHANGED";
    public static final String BROADCAST_EXTRA_OLD_WALKING_MODE = "com.inocreativeStudio.IncreaseHeightWorkout.EXTRA_OLD_WALKING_MODE";
    public static final String BROADCAST_EXTRA_NEW_WALKING_MODE = "com.inocreativeStudio.IncreaseHeightWorkout.EXTRA_NEW_WALKING_MODE";
