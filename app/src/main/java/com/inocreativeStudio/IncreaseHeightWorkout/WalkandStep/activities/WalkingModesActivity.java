...
import com.inocreativeStudio.IncreaseHeightWorkout.WalkandStep.adapters.WalkingModesAdapter;
    ...
    protected void showEditDialog(final Integer position) {
        ...
        alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double stepLength = Double.valueOf((stepLengthText.getText()!=null) ? "0" : stepLengthText.getText().toString());
